...
{{--                        <h3 class="mb-5">Data Pemohon</h3>--}}
                        <form action="{{route('pengajuan_data.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <!-- Data Pengaju -->
                            ...
                            <div class="row g-3 align-items-center pt-3">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" name="kategori_perusahaan">
                                </div>
                            </div>
                            ...
                            <div class="row g-3 align-items-center pt-3">
                                ...
                                <div class="col-6">
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control"  name="tmp_lahir1">
                                        </div>
                                        <div class="col">
                                            <input type="date" class="form-control"  name="Tgl_lahir1">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row g-3 align-items-center pt-3">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="pekerjaan_pemohon_cv1" name="pekerjaan1">
                                </div>
                            </div>
                            ...
                            <div class="row g-3 align-items-center pt-3">
                                ...
                                <div class="col-6">
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control"  name="tmp_lahir2">
                                        </div>
                                        <div class="col">
                                            <input type="date" class="form-control"  name="Tgl_lahir2">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row g-3 align-items-center pt-3">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="pekerjaan_pemohon_cv1" name="pekerjaan2">
                                </div>
                            </div>
                            ...
                            <div class="row g-3 align-items-center pt-3">
                                ...
                                <div class="col-6">
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control"  name="tmp_lahir3">
                                        </div>
                                        <div class="col">
                                            <input type="date" class="form-control"  name="Tgl_lahir3">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row g-3 align-items-center pt-3">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="pekerjaan_pemohon_cv1" name="pekerjaan3">
                                </div>
                            </div>
                            ...
                            <div class="row g-3 align-items-center mt-3">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="pemilik_kuasa" name="pemilik_kuasa">
                                </div>
                            </div>
                            <div class="row g-3 align-items-center pt-3">
                                <div class="col-4">
                                ...
                                <div class="col-6">
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control"  name="tempat_lahir_pemilik_kuasa">
                                        </div>
                                        <div class="col">
                                            <input type="date" class="form-control"  name="tgl_lahir_pemilik_kuasa">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 align-items-center pt-3">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="alamat_cv" name="alamat_cv">
                                </div>
                            </div>
                            <div class="row g-3 align-items-center pt-3">
                                <div class="col-4">
                                    <label for="bidang_usaha_cv" id="bidang_usaha_cv" name="bidang_usaha[]"
                            ...
                            <div class="row g-3 align-items-center pt-3">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="persero_aktif" name="persero_aktif">
                                </div>
                            </div>
                            <div class="row g-3 align-items-center pt-3">
                                <div class="col-4">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="persero_pasif" name="persero_pasif">
                                </div>
                            </div>
